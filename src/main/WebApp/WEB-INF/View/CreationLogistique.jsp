        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="row my-4">
                    <div class="card">
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/loginsert" method="post" autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <a href="${pageContext.request.contextPath}/insertAll" type="button" class="btn btn-primary" style="width: 100%">Valider</a>
                                    </div>
                                </div>
                            </form>
                        </div>
