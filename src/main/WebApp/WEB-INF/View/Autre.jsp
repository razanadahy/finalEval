...
<%
    Vector<Autre>list= (Vector<Autre>) request.getAttribute("list");
%>
        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="row my-4">
                    <div class="card">
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/insertAutre" method="post" autocomplete="off">
                                <div class="mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <a href="${pageContext.request.contextPath}/insertSono" type="button" class="btn btn-primary" style="width: 100%">Suivant</a>
                                    </div>
                                </div>
                            </form>
                        </div>
