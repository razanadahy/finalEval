...
<%@ page import="com.example.frontoffice.Model.Place" %><%
    ...
    Vector<Place>places=Place.list();
%>
    ...
    <div class="card col-10 offset-1 shadow-lg p-3 mb-5 bg-body rounded" >
        <div class="row">
                    ...
                    <div class="card-body">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><%=pl.getPrix()%></td>
                                <td><button onclick="showModal('<%=pl.getIdPrixPlace()%>')" type="button" class="btn btn-secondary">Modifier</button>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            </tr>
                            <% } %>
                            </tbody>
                        </table>
            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-body">
                        <form action="${pageContext.request.contextPath}/insertPlace" method="post" autocomplete="off">
                            <div class="mb-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Modifier point de vente</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="${pageContext.request.contextPath}/updatePlace" method="post" autocomplete="off">
                    <input type="hidden" id="id" name="idPrixPlace" value="0">

                    <div class="mb-3">
                        <label for="exampleInputEmail" class="form-label">Prix</label>
                        <input type="number" step="any" class="form-control" name="nom" id="exampleInputEmail" aria-describedby="emailHelp">
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <button type="submit" class="btn btn-primary" style="width: 100%">Inserer</button>
