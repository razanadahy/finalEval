  ...
  <div class="card col-10 offset-1 shadow-lg p-3 mb-5 bg-body rounded" >
    <div class="row">
      ...
      <div class="col-4">
        <div class="card">
          <div class="card-body">
            <form action="${pageContext.request.contextPath}/insertArtistModif" method="post" autocomplete="off">
              <div class="mb-3">
              ...
              <div class="row">
                ...
                <div class="col-6">
                  <a href="${pageContext.request.contextPath}/valider" type="button" class="btn btn-primary" style="width: 100%">valider</a>
                </div>
