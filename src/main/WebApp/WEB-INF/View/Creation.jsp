    ...
    <div class="row">
      ...
      <div class="col-4">
        <div class="row my-4">
          <div class="card">
            <div class="card-body">
              <form action="${pageContext.request.contextPath}/nextArtiste" method="post" autocomplete="off">
                <div class="mb-3">
                  <label for="n-0" class="form-label">Spectacle</label>
                  <input type="text" class="form-control" name="client" id="n-0" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                  <label for="n-2" class="form-label">Date du spectacle</label>
                  <input type="date" class="form-control" name="date" id="n-2" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
